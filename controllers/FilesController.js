 ...
 * the Controller for files related operations
...
class FilesController {
  ...
  static async postUpload(req, res) {
    ...
    if (type === 'folder') {
      ...
      // This creates a directory if it doesnt exists
  ...
  /**
   * @method writeToFile
   * @description Helper funct of @postUpload that writes the file to the disk
   * @param {Object} req - Express request object
   * @param {Object} res - Express response object
   * @returns {Object} - Express response object
   */
  static async writeToFile(res, filePath, data, newFile) {
    ...
    // This adds to queue to process file thumbnails
   ...
   * @description this retrieves user based on auth token
   * @param {Object} req - Express request object
   * @param {Object} res - Express response object
   * @returns {Object} - Express response object
   */
  ...
  /**
   * @method getShow
   * @description this code retrieves files based on id
   * @param {Object} req - Express request object
   * @param {Object} res - Express response object
   * @returns {Object} - Express response object
   */
  ...
  /**
   * @method getIndex
   * @description code retrieves files based on parentid and pagination
   * @param {Object} req - Express request object
   * @param {Object} res - Express response object
   * @returns {Object} - Express response object
   */
  static async getIndex(req, res) {
    ...
    // if parentId is not provided it retrieves all files
    let query;
    if (!parentId) {
      query = {
        userId: user._id.toString(),
    ...
    // This handles pagination using aggregation
  ...
  /**
   * @method putPublish
   * @description This set isPublic to true on the file document based on the ID
   * @param {Object} req - Express request object
   * @param {Object} res - Express response object
   * @returns {Object} - Express response object
   */
  ...
  /**
   * @method pubSubHelper
   * @ the helper method for @putPublish and @putUnpublish
   * @param {Object} req - Express request object
   * @param {Object} res - Express response object
  ...
  static async getFile(req, res) {
    ...
    // this code checks if file exists
    if (!(await FilesController.pathExists(lookUpPath))) {
      res.status(404).send({
        error: 'Not found',
      });
    } else {
      // this reads file with fs
